...
// swiftlint:disable cyclomatic_complexity line_length unneeded_break_in_switch function_body_length
public struct ImageProcess {
  ...
  public struct Util {
    ...
    static func drawImageInBounds(_ image: UIImage, bounds: CGRect) -> UIImage {
      return drawImageWithClosure(size: bounds.size, image: image) { (_, _) -> Void in
    ...
    public static func croppedImageWithRect(_ image: UIImage, rect: CGRect) -> UIImage {
      return drawImageWithClosure(size: rect.size, image: image) { (size: CGSize, context: CGContext) -> Void in
     ...
     */
    public static func drawImageWithClosure(size: CGSize, image: UIImage, closure: (_ size: CGSize, _ context: CGContext) -> Void) -> UIImage {
